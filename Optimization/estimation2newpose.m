...
% Insatziate local variable
radwheelL = vehicleparams.wheelLeft;
radwheelR = vehicleparams.wheelRight;
track     =  vehicleparams.track;
...
% free memory
clearvars res_encoder radwheelL radwheelR vehicleparamsM
clearvars diffleft diffright i
end
