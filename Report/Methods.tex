...
\subfloat[][\emph{dataset 1}.]
   {\includegraphics[width=0.45\textwidth]{odocam_1.eps}} \,
\subfloat[][\emph{dataset 2}.]
   {\includegraphics[width=0.45\textwidth]{odocam_2.eps}} \\
\subfloat[][\emph{dataset 3}.]
   {\includegraphics[width=0.45\textwidth]{odocam_3.eps}} \,
\subfloat[][\emph{dataset 4}.]
   {\includegraphics[width=0.45\textwidth]{odocam_4.eps}}
