...
%---------------------------------------------------------------------------------------- 
	...
	\newpage	
	\lstinputlisting[language=Matlab,label=lang:MatlabObjFunc,caption=gaerror.m]{/Users/francescoargentieri/Kinematics-Calibration-of-a-Differential-drive/Optimization/gaerror.m}
\end{document}
